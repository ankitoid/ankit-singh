...
const Navbar = () => {
  ...
  return (
    <nav className="fixed left-0 right-0 bg-gray-900  py-4 px-6 flex justify-between items-center z-50 dark:bg-gray-900">
      {/* Logo */}
      <div className="text-2xl font-bold bg-gray-600 md:p-[2px] rounded-2xl dark:text-white cursor-pointer" onClick={() => handleNavigation("heroSection")}> 
      ...
      <div
        className={`lg:flex lg:items-center lg:gap-8 absolute lg:static top-16 left-0 w-full lg:w-auto bg-white dark:bg-gray-900 lg:bg-transparent transition-all duration-300 ${
          navActive ? "flex flex-col items-center gap-6 py-6 shadow-md transition-all transform -translate-y-0 duration-500" : "hidden"
        }`}
      >
        <ul className="flex flex-col lg:flex-row gap-6 text-lg font-medium text-black md:text-white dark:text-white">
          <li>
            <span onClick={() => handleNavigation("heroSection")} className="hover:text-blue-600 cursor-pointer">
              Home
            </span>
          </li>
          <li>
